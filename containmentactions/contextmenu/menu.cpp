...
Menu::~Menu()
{
    ...
    m_actions.remove(Mocha::Data::ContextMenu::ADDVIEWACTION);
    m_actions.remove(Mocha::Data::ContextMenu::LAYOUTSACTION);
...
void Menu::restore(const KConfigGroup &config)
{
    ...
    //! Print Message...
    m_actions[Mocha::Data::ContextMenu::PRINTACTION] = new QAction(QIcon::fromTheme("edit"), "Print Message...", this);
    connect(m_actions[Mocha::Data::ContextMenu::PRINTACTION], &QAction::triggered, [ = ]() {
        qDebug() << "Action Triggered !!!";
    });

    //! Add Widgets...
    m_actions[Mocha::Data::ContextMenu::ADDWIDGETSACTION] = new QAction(QIcon::fromTheme("list-add"), i18n("&Add Widgets..."), this);
    m_actions[Mocha::Data::ContextMenu::ADDWIDGETSACTION]->setStatusTip(i18n("Show Widget Explorer"));
    connect(m_actions[Mocha::Data::ContextMenu::ADDWIDGETSACTION], &QAction::triggered, this, &Menu::requestWidgetExplorer);
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::ADDWIDGETSACTION, m_actions[Mocha::Data::ContextMenu::ADDWIDGETSACTION]);
    ...
    //! Edit Dock/Panel...
    m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION] = new QAction(QIcon::fromTheme("document-edit"), "Edit Dock...", this);
    connect(m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION], &QAction::triggered, this, &Menu::requestConfiguration);
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::EDITVIEWACTION, m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION]);
    ...
    m_actions[Mocha::Data::ContextMenu::LAYOUTSACTION] = m_switchLayoutsMenu->menuAction();
    m_actions[Mocha::Data::ContextMenu::LAYOUTSACTION]->setText(i18n("&Layouts"));
    m_actions[Mocha::Data::ContextMenu::LAYOUTSACTION]->setIcon(QIcon::fromTheme("user-identity"));
    m_actions[Mocha::Data::ContextMenu::LAYOUTSACTION]->setStatusTip(i18n("Switch to another layout"));
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::LAYOUTSACTION, m_actions[Mocha::Data::ContextMenu::LAYOUTSACTION]);
    ...
    m_actions[Mocha::Data::ContextMenu::ADDVIEWACTION] = m_addViewMenu->menuAction();
    m_actions[Mocha::Data::ContextMenu::ADDVIEWACTION]->setText(i18n("&Add Dock/Panel"));
    m_actions[Mocha::Data::ContextMenu::ADDVIEWACTION]->setIcon(QIcon::fromTheme("list-add"));
    m_actions[Mocha::Data::ContextMenu::ADDVIEWACTION]->setStatusTip(i18n("Add dock or panel based on specific template"));
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::ADDVIEWACTION, m_actions[Mocha::Data::ContextMenu::ADDVIEWACTION]);
    ...
    m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION] = m_moveToLayoutMenu->menuAction();
    m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->setText("Move To Layout");
    m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->setIcon(QIcon::fromTheme("transform-move-horizontal"));
    m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->setStatusTip(i18n("Move dock or panel to different layout"));
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::MOVEVIEWACTION, m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]);
    ...
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::DUPLICATEVIEWACTION, m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]);
    ...
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION, m_actions[Mocha::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION]);
    ...
    this->containment()->setInternalAction(Mocha::Data::ContextMenu::REMOVEVIEWACTION, m_actions[Mocha::Data::ContextMenu::REMOVEVIEWACTION]);
...
QList<QAction *> Menu::contextualActions()
{
    ...
    actions << m_actions[Mocha::Data::ContextMenu::SECTIONACTION];
    actions << m_actions[Mocha::Data::ContextMenu::PRINTACTION];
    for(int i=0; i<Mocha::Data::ContextMenu::ACTIONSEDITORDER.count(); ++i) {
        actions << m_actions[Mocha::Data::ContextMenu::ACTIONSEDITORDER[i]];
    }
    actions << m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION];
    ...
    m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION]->setText(configureActionText);

    const QString duplicateActionText = (m_view.type == DockView) ? i18n("&Duplicate Dock") : i18n("&Duplicate Panel");
    m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]->setText(duplicateActionText);
    ...
    m_actions[Mocha::Data::ContextMenu::REMOVEVIEWACTION]->setText(removeActionText);
...
{
    if (!m_actions.contains(Mocha::Data::ContextMenu::EDITVIEWACTION)
            || !m_actions.contains(Mocha::Data::ContextMenu::REMOVEVIEWACTION)) {
        return;
    }
    ...
    for(auto actionName: m_actions.keys()) {
        if (Mocha::Data::ContextMenu::ACTIONSSPECIAL.contains(actionName)) {
            continue;
        } else if (Mocha::Data::ContextMenu::ACTIONSALWAYSHIDDEN.contains(actionName)) {
    ...
    bool isshown = (m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->isVisible() && m_activeLayoutNames.count()>1);
    m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->setVisible(isshown);

    // special actions
    m_actions[Mocha::Data::ContextMenu::EDITVIEWACTION]->setVisible(!configuring);
    m_actions[Mocha::Data::ContextMenu::SECTIONACTION]->setVisible(true);

    if (m_view.isCloned) {
        m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]->setVisible(false);
        m_actions[Mocha::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION]->setVisible(false);
        m_actions[Mocha::Data::ContextMenu::MOVEVIEWACTION]->setVisible(false);
        m_actions[Mocha::Data::ContextMenu::REMOVEVIEWACTION]->setVisible(false);
    }
...
void Menu::populateViewTemplates()
{
    ...
    QAction *duplicateAction = m_addViewMenu->addAction(m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]->text());
    duplicateAction->setToolTip(m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]->toolTip());
    duplicateAction->setIcon(m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION]->icon());
    connect(duplicateAction, &QAction::triggered, m_actions[Mocha::Data::ContextMenu::DUPLICATEVIEWACTION], &QAction::triggered);
}
...
K_PLUGIN_CLASS_WITH_JSON(Menu, "plasma-containmentactions-mochacontextmenu.json")
