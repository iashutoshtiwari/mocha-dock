...
void LayoutMenuItemWidget::paintEvent(QPaintEvent* e)
{
    ...
    remained = Mocha::remainedFromLayoutIcon(opt, Qt::AlignLeft, 1, thickpadding);
    Mocha::drawLayoutIcon(&painter, opt, m_isBackgroundFile, m_iconName, Qt::AlignLeft, 1, thickpadding);
    opt.rect  = remained;
