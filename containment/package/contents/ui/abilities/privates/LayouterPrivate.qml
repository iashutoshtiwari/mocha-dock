...
Item {
    ...
    readonly property int maxLength: root.myView.alignment === MochaCore.Types.Justify ? contentsMaxLength : Math.min(root.minLength, contentsMaxLength)
    ...
    function computeStep1ForLayout(layout, availableSpace, sizePerApplet, noOfApplets, inMaxAutoFillCalculations) {
        for(var i=0; i<layout.children.length; ++i) {
            ...
            // console.log( "org.kde.mocha s3_-1 " + curApplet.pluginName + " : "+ curApplet.index +" (" +curApplet.isAutoFillApplet+","+!curApplet.isHidden +") ");
            // console.log( "org.kde.mocha s3_-1 " + curApplet.pluginName + " : "+ availableSpace + " _ " + sizePerApplet + " _ " + noOfApplets);
            ...
            if (curApplet && curApplet.isAutoFillApplet && !curApplet.isHidden
                ...
                // console.log( "org.kde.mocha s3_0 " + curApplet.pluginName + " : "+ curApplet.index +" (" +minSize+","+prefSize+","+maxSize+") ");
                ...
                if (!systemDecide) {
                    if (noOfApplets>1) {
                        ...
                        // console.log( "org.kde.mocha s3_1 " + curApplet.pluginName + " : (" +minSize+","+prefSize+","+maxSize+") -> " + appliedSize);
                        ...
                        // console.log( "org.kde.mocha s3_2 " + curApplet.pluginName + " : (" +minSize+","+prefSize+","+maxSize+") -> " + appliedSize);
                    }
                    ...
                    if (appliedSize>=0 && appliedSize<=sizePerApplet) {
                        ...
                        // console.log( "org.kde.mocha s3_3 " + curApplet.pluginName + " assigned: " + curApplet.maxAutoFillLength);
                    }
                }

                // console.log("org.kde.mocha s3_r " +curApplet.pluginName + " : " + availableSpace + " _ " + sizePerApplet + " _ " + noOfApplets + "\n");
            }
        }
            ...
            if (noOfApplets === 0) {
                ...
                for(var i=0; i<layout.children.length; ++i) {
                    ...
                    if (curApplet && curApplet.isAutoFillApplet && !curApplet.isHidden
                        ...
                        // console.log( " org.kde.mocha s4_0 " + curApplet.pluginName + " : (" +minSize+","+prefSize+","+maxSize+") ");
                ...
                if (mostDemandingApplet) {
                    ...
                    /*if (inMaxAutoFillCalculations) {
                        console.log(" org.kde.mocha s4_1  "+ mostDemandingApplet.applet.pluginName + " assigned max : "  + mostDemandingApplet.maxAutoFillLength + "\n");
                    } else {
                        console.log(" org.kde.mocha s4_1  "+ mostDemandingApplet.applet.pluginName + " assigned min: "  + mostDemandingApplet.minAutoFillLength + "\n");
                    }*/
                    ...
                    for (var j=0; j<neutralApplets.length; ++j) {
                        // console.log(" org.kde.mocha s4_2.0  "+ neutralApplets[j].pluginName + " _ " + neutralApplets[j].maxAutoFillLength + " _ " + adjustedAppletSize);
                        ...
                        // console.log(" org.kde.mocha s4_2.1  "+ neutralApplets[j].pluginName + " assigned: "  + sizePerApplet + "\n");
                    }
                }
            } else {
                for(var i=0; i<layout.children.length; ++i) {
                    ...
                    if (curApplet && curApplet.isAutoFillApplet && !curApplet.isHidden && curApplet.inFillCalculations) {
                        ...
                        // console.log(" org.kde.mocha s4_3  "+ curApplet.pluginName + " assigned: "  + sizePerApplet + "\n");
                        curApplet.inFillCalculations = false;
                    }
                }
            }
    ...
    function updateFillAppletsWithTwoSteps(inMaxAutoFillCalculations) {
        ...
        // console.log(" org.kde.mocha S3.1 main fill applets :: " + mainLayout.fillApplets);
        //! first pass
    ...
    function updateFillAppletsWithOneStep(inMaxAutoFillCalculations) {
        ...
        // console.log(" org.kde.mocha S2 _ SIZES ::: " + max_length + " ___ " + inMaxAutoFillCalculations + " __ " + startLayout.sizeWithNoFillApplets + " ___ " + mainLayout.sizeWithNoFillApplets + " ___ " + endLayout.sizeWithNoFillApplets);
        ...
        // console.log(" org.kde.mocha s5...");
    }


    function _updateSizeForAppletsInFill() {
        if (inNormalFillCalculationsState) {
            // console.log(" org.kde.mocha -------------");
            // console.log(" org.kde.mocha s1...");
            var noA = startLayout.fillApplets + mainLayout.fillApplets + endLayout.fillApplets;
            ...
            if (mainLayout.shownApplets === 0 || root.myView.alignment !== MochaCore.Types.Justify) {
