...
Data::View Storage::view(const KConfigGroup &containmentGroup)
{
    ...
    vdata.screensGroup = static_cast<Mocha::Types::ScreensGroup>(containmentGroup.readEntry("screensGroup", (int)Mocha::Types::SingleScreenGroup));
    ...
    int alignment = containmentGroup.group("General").readEntry("alignment", (int)Mocha::Types::Center) ;
    vdata.alignment = (Mocha::Types::Alignment)alignment;
...
int Storage::expectedViewScreenId(const Mocha::Corona *corona, const KConfigGroup &containmentGroup) const
{
...
int Storage::expectedViewScreenId(const Mocha::Corona *corona, const Data::View &view) const
{
    ...
    if (view.screensGroup == Mocha::Types::SingleScreenGroup || view.isCloned()) {
        return view.onPrimary ? corona->screenPool()->primaryScreenId() : view.screen;
    } else if (view.screensGroup == Mocha::Types::AllScreensGroup) {
        return corona->screenPool()->primaryScreenId();
    } else if (view.screensGroup == Mocha::Types::AllSecondaryScreensGroup) {
...
Data::ViewsTable Storage::views(const Layout::GenericLayout *layout)
{
    ...
    for (const auto containment : (*layout->containments())) {
        ...
        Mocha::View *vw = layout->viewForContainment(containment);
