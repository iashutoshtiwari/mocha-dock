...
public:
    ...
    Mocha::Data::Layout currentData() const;
...
private:
    ...
    void setBackgroundStyle(const Mocha::Layout::BackgroundStyle &style);

    void loadLayout(const Mocha::Data::Layout &data);
...
private:
    ...
    Mocha::Data::Layout o_data;
    Mocha::Data::Layout c_data;
};
