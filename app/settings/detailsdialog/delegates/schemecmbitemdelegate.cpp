...
void SchemeCmbItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    //! icon
    QRect remained = Mocha::remainedFromColorSchemeIcon(myOptions, Qt::AlignLeft, 4, 2);
    Mocha::drawColorSchemeIcon(painter, myOptions, textcolor, backcolor, Qt::AlignLeft, 5, 2); //+1px in order to take into account popup window border
