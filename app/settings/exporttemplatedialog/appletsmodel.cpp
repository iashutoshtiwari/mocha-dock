    ...
    : QAbstractTableModel(parent)
{
    m_appletsWithNoPersonalData = {
        "org.kde.mocha.separator",
        "org.kde.mocha.spacer",
        "org.kde.mocha.plasmoid",
        "org.kde.windowtitle",
...
void Applets::setData(const Mocha::Data::AppletsTable &applets)
{
    clear();
...
void Applets::setSelected(const Mocha::Data::AppletsTable &applets)
{
    bool changed{false};
...
Mocha::Data::AppletsTable Applets::selectedApplets()
{
