...
Views::Views(QObject *parent, Mocha::Corona *corona)
...
const Mocha::Data::View &Views::at(const int &row)
{
    return m_viewsTable[row];
}

const Mocha::Data::View Views::currentData(const QString &id)
{
    if (!m_viewsTable.containsId(id)) {
        return Mocha::Data::View();
    }
...
const Mocha::Data::View Views::originalData(const QString &id)
{
...
const Mocha::Data::ViewsTable &Views::currentViewsData()
{
    return m_viewsTable;
}

const Mocha::Data::ViewsTable &Views::originalViewsData()
{
    return o_viewsTable;
}
...
{
    if (view.alignment == Mocha::Types::Top || view.alignment == Mocha::Types::Left) {
        return 1;
    } else if (view.alignment == Mocha::Types::Center) {
        return 2;
    } else if (view.alignment == Mocha::Types::Bottom || view.alignment == Mocha::Types::Right) {
        return 3;
    }
...
void Views::initEdges()
{
    ...
    s_edges[i].edge = Plasma::Types::TopEdge; s_edges[i].alignment = Mocha::Types::Center;
    s_edges[i].setState(Data::View::IsCreated);

    i++;
    s_edges << Data::View(QString::number(Plasma::Types::LeftEdge), i18nc("left edge", "Left"));
    s_edges[i].edge = Plasma::Types::LeftEdge; s_edges[i].alignment = Mocha::Types::Center;
    s_edges[i].setState(Data::View::IsCreated);

    i++;
    s_edges << Data::View(QString::number(Plasma::Types::BottomEdge), i18nc("bottom edge", "Bottom"));
    s_edges[i].edge = Plasma::Types::BottomEdge; s_edges[i].alignment = Mocha::Types::Center;
    s_edges[i].setState(Data::View::IsCreated);

    i++;
    s_edges << Data::View(QString::number(Plasma::Types::RightEdge), i18nc("right edge", "Right"));
    s_edges[i].edge = Plasma::Types::RightEdge; s_edges[i].alignment = Mocha::Types::Center;
    s_edges[i].setState(Data::View::IsCreated);
}
...
void Views::initAlignments()
{
    ...
    int i=0; // Left / Top
    s_horizontalAlignments << Data::View(QString::number(Mocha::Types::Left), i18nc("left alignment", "Left"));
    s_horizontalAlignments[i].edge = Plasma::Types::BottomEdge; s_horizontalAlignments[i].alignment = Mocha::Types::Left;
    s_horizontalAlignments[i].setState(Data::View::IsCreated);

    s_verticalAlignments << Data::View(QString::number(Mocha::Types::Top), i18nc("top alignment", "Top"));
    s_verticalAlignments[i].edge = Plasma::Types::LeftEdge; s_verticalAlignments[i].alignment = Mocha::Types::Top;
    s_verticalAlignments[i].setState(Data::View::IsCreated);

    i++; // Center
    s_horizontalAlignments << Data::View(QString::number(Mocha::Types::Center), i18nc("center alignment", "Center"));
    s_horizontalAlignments[i].edge = Plasma::Types::BottomEdge; s_horizontalAlignments[i].alignment = Mocha::Types::Center;
    s_horizontalAlignments[i].setState(Data::View::IsCreated);
    ...
    i++; // Right / Bottom
    s_horizontalAlignments << Data::View(QString::number(Mocha::Types::Right), i18nc("right alignment", "Right"));
    s_horizontalAlignments[i].edge = Plasma::Types::BottomEdge; s_horizontalAlignments[i].alignment = Mocha::Types::Right;
    s_horizontalAlignments[i].setState(Data::View::IsCreated);

    s_verticalAlignments << Data::View(QString::number(Mocha::Types::Bottom), i18nc("bottom alignment", "Bottom"));
    s_verticalAlignments[i].edge = Plasma::Types::LeftEdge; s_verticalAlignments[i].alignment = Mocha::Types::Bottom;
    s_verticalAlignments[i].setState(Data::View::IsCreated);

    i++; // Justify
    s_horizontalAlignments << Data::View(QString::number(Mocha::Types::Justify), i18nc("justify alignment", "Justify"));
    s_horizontalAlignments[i].edge = Plasma::Types::BottomEdge; s_horizontalAlignments[i].alignment = Mocha::Types::Justify;
    s_horizontalAlignments[i].setState(Data::View::IsCreated);
...
Data::ViewsTable Views::edgesChoices(const Data::View &view) const
{
    ...
    if (view.alignment == Mocha::Types::Left) {
        t_edges[0].alignment = view.alignment;
        t_edges[1].alignment = Mocha::Types::Top;
        t_edges[2].alignment = view.alignment;
        t_edges[3].alignment = Mocha::Types::Top;
    } else if (view.alignment == Mocha::Types::Top) {
        t_edges[0].alignment = Mocha::Types::Left;
        t_edges[1].alignment = view.alignment;
        t_edges[2].alignment = Mocha::Types::Left;
        t_edges[3].alignment = view.alignment;
    } else if (view.alignment == Mocha::Types::Center
               || view.alignment == Mocha::Types::Justify) {
        t_edges[0].alignment = view.alignment;
        t_edges[1].alignment = view.alignment;
        t_edges[2].alignment = view.alignment;
        t_edges[3].alignment = view.alignment;
    } else if (view.alignment == Mocha::Types::Right) {
        t_edges[0].alignment = view.alignment;
        t_edges[1].alignment = Mocha::Types::Bottom;
        t_edges[2].alignment = view.alignment;
        t_edges[3].alignment = Mocha::Types::Bottom;
    } else if (view.alignment == Mocha::Types::Bottom) {
        t_edges[0].alignment = Mocha::Types::Right;
        t_edges[1].alignment = view.alignment;
        t_edges[2].alignment = Mocha::Types::Right;
        t_edges[3].alignment = view.alignment;
    }
...
void Views::appendTemporaryView(const Mocha::Data::View &view)
{
...
Mocha::Data::Screen Views::screenData(const QString &viewId) const
{
    int row = rowForId(viewId);

    if (row < 0) {
        return Mocha::Data::Screen();
    }
   ...
   // QString primaryid = QString::number(m_corona->screenPool()->primaryScreenId());
    ...
    if (m_viewsTable[row].onPrimary || (m_viewsTable[row].screensGroup == Mocha::Types::AllScreensGroup)) {
        scrData = s_screens[0]; //primary, allscreens
    } else if (m_viewsTable[row].screensGroup == Mocha::Types::AllSecondaryScreensGroup) {
    ...
    if (m_viewsTable[row].screensGroup == Mocha::Types::AllScreensGroup) {
...
Mocha::Data::ViewsTable Views::alteredViews() const
{
    Mocha::Data::ViewsTable views;
...
Mocha::Data::ViewsTable Views::newViews() const
{
    Mocha::Data::ViewsTable views;
...
void Views::updateCurrentView(QString currentViewId, Mocha::Data::View &view)
{
...
void Views::setOriginalView(QString currentViewId, Mocha::Data::View &view)
{
    if (!m_viewsTable.containsId(currentViewId)) {
        return;
    }
...
void Views::setOriginalData(Mocha::Data::ViewsTable &data)
{
    clear();
...
bool Views::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    case SCREENCOLUMN:
        if (role == Qt::UserRole) {
            ...
            bool onprimary = (screen == Mocha::Data::Screen::ONPRIMARYID);
            bool onallscreens = (screen == Mocha::Data::Screen::ONALLSCREENSID);
            bool onallsecscreens = (screen == Mocha::Data::Screen::ONALLSECONDARYSCREENSID);

            if (onprimary) {
                m_viewsTable[row].onPrimary = true;
                m_viewsTable[row].screensGroup = Mocha::Types::SingleScreenGroup;
            } else if (onallscreens) {
                m_viewsTable[row].onPrimary = true;
                m_viewsTable[row].screensGroup = Mocha::Types::AllScreensGroup;
            } else if (onallsecscreens) {
                m_viewsTable[row].onPrimary = false;
                m_viewsTable[row].screensGroup = Mocha::Types::AllSecondaryScreensGroup;
            } else {
                m_viewsTable[row].onPrimary = false;
                m_viewsTable[row].screensGroup = Mocha::Types::SingleScreenGroup;
    ...
    case EDGECOLUMN:
        if (role == Qt::UserRole) {
            ...
            if (previousFactor != currentFactor) {
                if (m_viewsTable[row].alignment == Mocha::Types::Left) {
                    m_viewsTable[row].alignment = Mocha::Types::Top;
                } else if (m_viewsTable[row].alignment == Mocha::Types::Right) {
                    m_viewsTable[row].alignment = Mocha::Types::Bottom;
                } else if (m_viewsTable[row].alignment == Mocha::Types::Top) {
                    m_viewsTable[row].alignment = Mocha::Types::Left;
                } else if (m_viewsTable[row].alignment == Mocha::Types::Bottom) {
                    m_viewsTable[row].alignment = Mocha::Types::Right;
                }
    ...
    case ALIGNMENTCOLUMN:
        if (role == Qt::UserRole)  {
            ...
            m_viewsTable[row].alignment = static_cast<Mocha::Types::Alignment>(alignment);
            emit dataChanged(this->index(row, NAMECOLUMN), this->index(row, ALIGNMENTCOLUMN), roles);
            return true;
        }
        break;
...
QVariant Views::data(const QModelIndex &index, int role) const
{
    ...
    if (role == IDROLE) {
        ...
        if (column == SCREENCOLUMN) {
            Mocha::Data::ScreensTable currentScreens = s_screens;
            ...
            edgesVariant.setValue<Mocha::Data::ViewsTable>(edgesChoices(m_viewsTable[row]));
            return edgesVariant;
        } else if (column == ALIGNMENTCOLUMN) {
            QVariant alignmentsVariant;

            if (isVertical(m_viewsTable[row].edge)) {
                alignmentsVariant.setValue<Mocha::Data::ViewsTable>(verticalAlignmentChoices(m_viewsTable[row]));
            } else {
                alignmentsVariant.setValue<Mocha::Data::ViewsTable>(horizontalAlignmentChoices(m_viewsTable[row]));
            }
        ...
        Mocha::Data::Screen scrdata = screenData(m_viewsTable[row].id);
        QVariant::fromValue(scrdata);
    } else if (role == VIEWROLE) {
        Mocha::Data::View view = m_viewsTable[row];
    ...
    case SCREENCOLUMN:
        if (role == Qt::DisplayRole){
            if (m_viewsTable[row].screensGroup == Mocha::Types::SingleScreenGroup &&  m_viewsTable[row].onPrimary) {
                return i18nc("primary screen", "Primary");
            } else if (m_viewsTable[row].screensGroup == Mocha::Types::AllScreensGroup) {
    ...
    case ALIGNMENTCOLUMN:
        if (role == Qt::DisplayRole){
            if (m_viewsTable[row].alignment == Mocha::Types::Center) {
                return i18nc("center alignment", "Center");
            } else if (m_viewsTable[row].alignment == Mocha::Types::Left) {
            ...
            } else if (m_viewsTable[row].alignment == Mocha::Types::Justify) {
