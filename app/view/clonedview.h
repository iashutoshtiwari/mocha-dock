...
public:
    ...
    ClonedView(Plasma::Corona *corona, Mocha::OriginalView *originalView, QScreen *targetScreen = nullptr, bool byPassX11WM = false);
    ~ClonedView();
    ...
    Mocha::Data::View data() const override;
...
private:
    ...
    QPointer<Mocha::OriginalView> m_originalView;
