...
ViewPart::PrimaryConfigView *ViewSettingsFactory::primaryConfigView(Mocha::View *view)
{
    if (!m_primaryConfigView) {
...
ViewPart::WidgetExplorerView *ViewSettingsFactory::widgetExplorerView(Mocha::View *view)
{
