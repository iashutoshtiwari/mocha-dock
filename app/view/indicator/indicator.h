...
class Indicator: public QObject
{
    ...
    /**
      ...
      */
    Q_PROPERTY(Mocha::ViewPart::IndicatorPart::Info *info READ info NOTIFY infoChanged)

    /**
      * Resources provided from the indicator itself
      */
    Q_PROPERTY(Mocha::ViewPart::IndicatorPart::Resources *resources READ resources NOTIFY resourcesChanged)


public:
    Indicator(Mocha::View *parent);
    virtual ~Indicator();
