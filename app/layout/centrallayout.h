...
{
    Q_OBJECT
    Q_PROPERTY(Mocha::WindowSystem::SchemeColors *scheme READ scheme NOTIFY schemeChanged)
...
public:
    ...
    Mocha::WindowSystem::SchemeColors *scheme() const;
...
private:
    ...
    void setScheme(Mocha::WindowSystem::SchemeColors *_scheme);
...
private:
    ...
    Mocha::WindowSystem::SchemeColors *m_scheme{nullptr};
};
