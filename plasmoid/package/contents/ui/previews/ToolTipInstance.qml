    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                color: hoverHandler.containsPress ? Kirigami.Theme.highlightColor : Qt.rgba(Kirigami.Theme.highlightColor.r, Kirigami.Theme.highlightColor.g, Kirigami.Theme.highlightColor.b, 0.3)
                radius: 3
            }
